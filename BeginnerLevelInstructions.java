...
Teacher: Ms. Krasteva
Description: This class displays the instructions for the beginner level.
*/
...
public class BeginnerLevelInstructions extends JFrame implements MouseListener{
	...
	public BeginnerLevelInstructions() {
		...
		label.setIcon(new ImageIcon(new ImageIcon("Images/Example Logo.png").getImage().getScaledInstance(530, 130, Image.SCALE_DEFAULT)));
